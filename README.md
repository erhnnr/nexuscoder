...
## Versiyon geçmişi (sonuçlarla)

| Versiyon | Veri | Parametre | Dönüş epoch'u | En iyi val_loss | Durum |
|----------|------|-----------|----------------|------------------|-------|
| v1 | 1.374 (karışık dil) | 14.7M | 13 | 4.26 | Tamamlandı |
| v2 | 25.374 (karışık dil) | 14.7M | ~6 | 2.76 | Tamamlandı |
| v3 | 22.800 (temiz İngilizce) | 17.0M | 30 | 2.42 | Tamamlandı |
| v4 | 285.000 (temiz İngilizce) | 41.8M | 42 | **1.49** | Tamamlandı, en iyi checkpoint: `model_v4_best.pt` |

Detaylı kararlar ve gerekçeler için bkz. `docs/adr/` klasörü (0001-0012).
